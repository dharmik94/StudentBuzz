...
public class AssignActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lve = (ListView) findViewById(R.id.listViewassign);
    ...
    public static class JsonEvent {
        ...
        public static List<String> Parse(String json){
            try {
                ...
                JSONArray cast = jsonResponse.getJSONArray("Assignment");
                for (int i=0; i<cast.length(); i++) {
                    JSONObject actor = cast.getJSONObject(i);
                    eventList.add(actor.getString("assin_name"));
                }
                return eventList;
    ...
    public class EventtActivity extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(AssignActivity.this);
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                link = "http://10.0.3.2/Studentbuzzapp/assign.php" + data;
